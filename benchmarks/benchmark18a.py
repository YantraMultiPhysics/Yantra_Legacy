...
domain= yantra.Domain3D((0,0,0),(1.99,0.5*l,0.5*l),dx, grid_type = 'nodal',periodicity={'x':1,'y':1,'z':1})
#%% setup physics
x,y,z = domain.meshgrid()
visc = 1./6.
domain_params={}
...
solver_params={'lattice':'D3Q19','collision_model':'trt','forcing_model':'guo','magic_para':3./16.,'tauref':0.8}
...
plt.figure()
plt.title('u_darcy')
plt.plot(x[10,10,:],ns.u_darcy[0][10,10,:],'-')
plt.legend(['LB','Analytical'])
plt.xlabel('distance')
plt.ylabel('velocity')
plt.show()
