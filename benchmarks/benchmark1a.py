...
#=======================================================================================
__doc__ ="""
Benchmark 1a: Comparision of 2D implementation of Yantra's multilevel \
advection diffusion model with 1D analytical solution for infinite domain with \
...
domain = yantra.Domain2D((0,0),(200,20),1, grid_type = 'nodal',periodicity={'x':0,'y':1})
#%% Define physics
cb = 1
ux=0.01
D=0.1
